<template>
    <div>
        <el-card class="box-card">
            ...
            <el-table v-loading="table.loading" :data="table.tableData" border style="width: 100%;margin-top: 10px;margin-bottom: 10px;">
                ...
                <el-table-column prop="teamid" label="所属部门">
                    <template slot-scope="scope">{{ getTeamName(scope.row.teamid) }}</template>
                </el-table-column>
        ...
        <el-dialog :visible.sync="pop.form" width="500px">
            <date-form ref="dateForm" :type="settings.form.type" :close="closeForm" :teamidOptions="teamidOptions"></date-form>
        </el-dialog>
    </div>
</template>
