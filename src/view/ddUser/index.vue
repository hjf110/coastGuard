<template>
    <div>
        <el-card class = "box-card">
            <el-input style = "width: 180px;margin: 0 10px;" autocomplete = "off" placeholder = "输入要查询的人员姓名"
        ...
        <el-dialog v-dialogDrag :title = "settings.form.type === 1 ? '添加账号' : '修改账号'" :visible.sync = "settings.form.show"
                width = "300px">
...
export default {
    ...
    methods: {
        getPoint() {
            point.list({ page: 1, limit: 10000 }).then(res => {
        ...
        submit() {
            if (this.form.b && !this.form.a) {
                ...
                if (this.settings.form.type === 1) {
                    ...
                    let aa = '';
                    let bb = '';
                    if (this.form.a) {//说明填了区域
                        aa = this.form.a;
                    } else {
                        aa = '--';
                    }
                    if (this.form.b) {//说明填了区域
                        bb = this.form.b;
                    } else {
                        bb = '--';
                    }
                    ...
                    ddUser.edit(this.form).then(res => {
                        console.log(res);
                        this.settings.form.loading = false;
